...
;	}
	...
	public ResponseEntity<Employee> getEmployeeeById(@PathVariable int empId){
		Employee employee = 
	...
	{ 
	Employee employee = 
	employeeRepository.findById(empId).orElseThrow(() -> new EmployeeNotFoundException("Employee with Employee Id "+empId+" does not exist")); 
